...
export { DriverConfigError, FRAME_PROTOCOL, FRAME_USER_BINARY, FRAME_USER_TEXT, GathoError, InvalidTagError, RoomNotFoundError, RoomNotRunningError, RoomStartError, RoomTimeoutError, ServerNotFoundError, createFrameReader, createLogger, createSilentLogger, frameUserMessage, ipcCodec, jwtSign, jwtVerify, log, packProtocol, packUserBinary, packUserText, sendMessage, unpackFrame };
