...
// everyone's latest position. Same plain-options shape as echo.ts — a second room
// type proves two independent isolates in one workerd process.
//
// Exports a plain options object (this example's adapter convention, not a gatho
// API — see README and rooms/echo.ts).
