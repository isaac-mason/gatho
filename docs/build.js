...
function resolveModuleToSourceDir(modulePath) {
    ...
    // Handle subpath exports (e.g., "gatho/three" -> "./three")
...
readmeText = readmeText.replace(apiDocsLinkRegex, (fullMatch, functionName) => {
    return `**[\`${functionName}\` API Documentation →](https://gatho.dev/docs/functions/gatho.${functionName}.html)**`;
});

/* <RenderType type="import('gatho').TypeName" /> */
...
/* <RenderSource type="import('gatho').TypeName" /> */
